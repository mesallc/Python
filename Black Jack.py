...
def Win(): #Сообещние о выйгрыше, выводим сообщение с балансами обоих игроков
    print('\n\n\n\n\n\n\n\n\n\n\n')
    print('----[Вы выйграли]----')
...
def Lose(): #Сообещние о пройгрыше, выводим сообщение с балансами обоих игроков
    print('\n\n\n\n\n\n\n\n\n\n\n')
    print('----[Вы проиграли]----')
    print('Ваш баланс: ' + str(MAIN_KOLODA))
    print('Баланс крупье: ' + str(KRUPIE_KOLODA))
...
def Nothing(): #Сообещние о ничьей, выводим сообщение с балансами обоих игроков
    print('\n\n\n\n\n\n\n\n\n\n\n')
    print('----[Ничья]----')
    print('Ваш баланс: ' + str(MAIN_KOLODA))
    print('Баланс крупье: ' + str(KRUPIE_KOLODA))
